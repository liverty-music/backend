...
// NotifyNewConcerts provides a mock function with given fields: ctx, data
func (_m *MockPushNotificationUseCase) NotifyNewConcerts(ctx context.Context, data usecase.ConcertCreatedData) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, usecase.ConcertCreatedData) error); ok {
		r0 = rf(ctx, data)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *MockPushNotificationUseCase_Expecter) NotifyNewConcerts(ctx interface{}, data interface{}) *MockPushNotificationUseCase_NotifyNewConcerts_Call {
	return &MockPushNotificationUseCase_NotifyNewConcerts_Call{Call: _e.mock.On("NotifyNewConcerts", ctx, data)}
}

func (_c *MockPushNotificationUseCase_NotifyNewConcerts_Call) Run(run func(ctx context.Context, data usecase.ConcertCreatedData)) *MockPushNotificationUseCase_NotifyNewConcerts_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(usecase.ConcertCreatedData))
	})
	return _c
}
...
func (_c *MockPushNotificationUseCase_NotifyNewConcerts_Call) RunAndReturn(run func(context.Context, usecase.ConcertCreatedData) error) *MockPushNotificationUseCase_NotifyNewConcerts_Call {
	_c.Call.Return(run)
	return _c
}
