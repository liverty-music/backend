...
func (_m *MockConcertUseCase) ListSearchStatuses(ctx context.Context, artistIDs []string) ([]*usecase.SearchStatus, error) {
	...
	var r0 []*usecase.SearchStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]*usecase.SearchStatus, error)); ok {
		return rf(ctx, artistIDs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) []*usecase.SearchStatus); ok {
		r0 = rf(ctx, artistIDs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*usecase.SearchStatus)
		}
	}
...
func (_c *MockConcertUseCase_ListSearchStatuses_Call) Return(_a0 []*usecase.SearchStatus, _a1 error) *MockConcertUseCase_ListSearchStatuses_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConcertUseCase_ListSearchStatuses_Call) RunAndReturn(run func(context.Context, []string) ([]*usecase.SearchStatus, error)) *MockConcertUseCase_ListSearchStatuses_Call {
	_c.Call.Return(run)
	return _c
}
