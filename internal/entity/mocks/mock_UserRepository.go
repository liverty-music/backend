...
func (_m *MockUserRepository) Create(ctx context.Context, params *entity.NewUser) (*entity.User, error) {
...
func (_c *MockUserRepository_Create_Call) Run(run func(ctx context.Context, params *entity.NewUser)) *MockUserRepository_Create_Call {
...
func (_c *MockUserRepository_Create_Call) RunAndReturn(run func(context.Context, *entity.NewUser) (*entity.User, error)) *MockUserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockUserRepository) Get(ctx context.Context, id string) (*entity.User, error) {
	ret := _m.Called(ctx, id)
...
func (_c *MockUserRepository_Get_Call) RunAndReturn(run func(context.Context, string) (*entity.User, error)) *MockUserRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockUserRepository) Update(ctx context.Context, id string, params *entity.NewUser) (*entity.User, error) {
	...
	var r0 *entity.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *entity.NewUser) (*entity.User, error)); ok {
		return rf(ctx, id, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *entity.NewUser) *entity.User); ok {
		r0 = rf(ctx, id, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.User)
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, *entity.NewUser) error); ok {
		r1 = rf(ctx, id, params)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockUserRepository_Update_Call) Run(run func(ctx context.Context, id string, params *entity.NewUser)) *MockUserRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(*entity.NewUser))
	})
	return _c
}
...
func (_c *MockUserRepository_Update_Call) RunAndReturn(run func(context.Context, string, *entity.NewUser) (*entity.User, error)) *MockUserRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockUserRepository) UpdateSafeAddress(ctx context.Context, id string, safeAddress string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateSafeAddress")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) error); ok {
		r0 = rf(ctx, id, safeAddress)
	} else {
		r0 = ret.Error(0)
	}
...
// MockUserRepository_UpdateSafeAddress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateSafeAddress'
type MockUserRepository_UpdateSafeAddress_Call struct {
	*mock.Call
}

// UpdateSafeAddress is a helper method to define mock.On call
//   - ctx context.Context
//   - id string
//   - safeAddress string
func (_e *MockUserRepository_Expecter) UpdateSafeAddress(ctx interface{}, id interface{}, safeAddress interface{}) *MockUserRepository_UpdateSafeAddress_Call {
	return &MockUserRepository_UpdateSafeAddress_Call{Call: _e.mock.On("UpdateSafeAddress", ctx, id, safeAddress)}
}

func (_c *MockUserRepository_UpdateSafeAddress_Call) Run(run func(ctx context.Context, id string, safeAddress string)) *MockUserRepository_UpdateSafeAddress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUserRepository_UpdateSafeAddress_Call) Return(_a0 error) *MockUserRepository_UpdateSafeAddress_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockUserRepository_UpdateSafeAddress_Call) RunAndReturn(run func(context.Context, string, string) error) *MockUserRepository_UpdateSafeAddress_Call {
	_c.Call.Return(run)
	return _c
}
