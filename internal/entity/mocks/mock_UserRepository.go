...
func (_mock *MockUserRepository) Create(ctx context.Context, params *entity.NewUser) (*entity.User, error) {
...
func (_c *MockUserRepository_Create_Call) RunAndReturn(run func(ctx context.Context, params *entity.NewUser) (*entity.User, error)) *MockUserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockUserRepository) Get(ctx context.Context, id string) (*entity.User, error) {
	ret := _mock.Called(ctx, id)
...
func (_c *MockUserRepository_Get_Call) RunAndReturn(run func(ctx context.Context, id string) (*entity.User, error)) *MockUserRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockUserRepository) Update(ctx context.Context, id string, params *entity.NewUser) (*entity.User, error) {
	...
	var r0 *entity.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *entity.NewUser) (*entity.User, error)); ok {
		return returnFunc(ctx, id, params)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, *entity.NewUser) *entity.User); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, *entity.NewUser) error); ok {
...
func (_c *MockUserRepository_Update_Call) Run(run func(ctx context.Context, id string, params *entity.NewUser)) *MockUserRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg2 *entity.NewUser
		if args[2] != nil {
			arg2 = args[2].(*entity.NewUser)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockUserRepository_Update_Call) Return(user *entity.User, err error) *MockUserRepository_Update_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserRepository_Update_Call) RunAndReturn(run func(ctx context.Context, id string, params *entity.NewUser) (*entity.User, error)) *MockUserRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
