...
require (
	buf.build/gen/go/liverty-music/schema/connectrpc/go v1.20.0-20260830052230-2a3654853564.1
	buf.build/gen/go/liverty-music/schema/protocolbuffers/go v1.36.12-20260830052230-2a3654853564.1
